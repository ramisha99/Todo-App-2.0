...
function findTodoByText(text) {
    ...
    const findTodoWithText = todoItems.findIndex((todoInsideArray) => todoInsideArray.text == text);
...
function removeTodo(itemsToRemove) {
    ...
    const indexOfTodoToDelete = todoItems.indexOf((todoInArray) => todoInArray.id === itemsToRemove.id);
    // remove that todo
